...
def start(update: Update, _: CallbackContext) -> int:
    ...
    update.message.reply_text(
        '🚴🏻‍♀️ Во время регистрации Вы сможете выбрать один из вариантов участия: офлайн или онлайн. Давайте немного расскажем Вам о каждом из из них:\n\n'
        '1️⃣При офлайн варианте Вы получите карту с пикетами и будете стартовать из общей точки с другими участниками. Когда все задания выполнены, а время марафона подходит к концу, участники направляются на финиш. ❗️Такой вариант прохождения будет доступен только 29 мая. \n\n'
        '2️⃣А при онлайн варианте сможете  выбрать любой из районов с уже заготовленными точками и начать свой маршрут прямиком из дома. ❗️Такой вариант прохождения будет доступен только 30 мая.\n\n'
