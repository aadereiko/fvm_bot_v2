...
def start(update: Update, _: CallbackContext) -> int:
    ...
    update.message.reply_text(
        '🚴 Во время регистрации Вы сможете выбрать один из вариантов участия: <b>офлайн или онлайн</b>. Давайте немного расскажем Вам о каждом из из них:\n\n'
        '1️⃣ <b>Офлайн-формат можно пройти 12 июня.</b> Вы получите карту с пикетами и будете стартовать из общей точки с другими участниками. Когда все задания выполнены, а время марафона подходит к концу, участники направляются на финиш. \n\n'
        '2️⃣ <b>Онлайн-формат можно пройти 13 июня.</b> Вы сможете  выбрать любой из районов с уже заготовленными точками и начать свой маршрут прямиком из дома.\n\n'
